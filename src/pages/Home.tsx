...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      error => {
        console.error(
          '❌ Home: Error fetching live streams from Firestore:',
          error
        )
    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-900 via-blue-900 to-slate-800'>
          ...
          <div className='text-center py-4 sm:py-8 lg:py-16'>
            <div className='mb-4 sm:mb-6 lg:mb-8'>
              ...
              <p className='text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 mb-4 sm:mb-6 lg:mb-8 max-w-3xl mx-auto leading-relaxed px-2'>
                ...
                Discover rare corals, exotic fish, and marine wonders in
                real-time.
              </p>
            </div>
          ...
          {loadingStreams ? (
            ...
            <div className='text-center py-12'>
              ...
              <p className='text-blue-200 mb-8 max-w-2xl mx-auto'>
                Be the first to go live! Start streaming your marine treasures
                and connect with buyers in real-time.
              </p>
              <Link
                to='/go-live'
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-white mb-6'>
              Why Choose CoralCrave?
            </h2>
            <p className='text-xl text-blue-200 max-w-3xl mx-auto'>
              Experience the future of marine commerce with live, interactive
              auctions
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-slate-700/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20 hover:border-cyan-400/40 transition-all duration-300 hover:transform hover:scale-105'>
              ...
              <p className='text-blue-200 text-center leading-relaxed'>
                See every detail in real-time. Watch corals sway, fish swim, and
                equipment in action before you bid.
              </p>
            </div>
            ...
            <div className='bg-slate-700/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20 hover:border-cyan-400/40 transition-all duration-300 hover:transform hover:scale-105'>
              ...
              <p className='text-blue-200 text-center leading-relaxed'>
                Fast-paced auctions with instant updates. Experience the thrill
                of live bidding from anywhere.
              </p>
            </div>
            ...
            <div className='bg-slate-700/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20 hover:border-cyan-400/40 transition-all duration-300 hover:transform hover:scale-105'>
              ...
              <p className='text-blue-200 text-center leading-relaxed'>
                Verified sellers, secure payments, and a community of passionate
                marine enthusiasts.
              </p>
            </div>
          </div>
      ...
      <div className='relative py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-white mb-6'>
              Discover Marine Categories
            </h2>
            <p className='text-xl text-blue-200 max-w-3xl mx-auto'>
              From vibrant corals to exotic fish, find exactly what you're
              looking for
            </p>
          </div>
      ...
      <div className='relative py-20 bg-gradient-to-r from-slate-800 to-slate-900'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-blue-200 mb-8 leading-relaxed'>
            Join thousands of marine enthusiasts buying and selling the ocean's
