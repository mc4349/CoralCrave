    ...
    return (
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-slate-300 mb-6'>Please sign in to access the livestream</p>
          <a href='/auth' className='bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors'>
            Sign In
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-white mb-2">Go Live - CoralCrave Auctions</h1>
          <p className="text-slate-300">Welcome back, {userProfile?.username || currentUser.email}!</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-800 rounded-lg p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-3">
                  {!publishing ? (
                    <button onClick={() => setShowSetup(true)} className="px-8 py-4 rounded-lg bg-red-600 hover:bg-red-700 text-white font-bold text-lg transition-all transform hover:scale-105 shadow-lg">
                      🚀 GO LIVE
                    </button>
                  ) : (
                    <button onClick={stop} className="px-8 py-4 rounded-lg bg-gray-600 hover:bg-gray-700 text-white font-bold text-lg transition-all shadow-lg">
                      ⏹️ END STREAM
                    </button>
                  )}
                </div>
              ...
              <div className="relative">
                <div ref={localRef} className="w-full h-[500px] bg-black rounded-lg overflow-hidden shadow-2xl" />
                {!publishing && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/70 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-slate-300 text-lg mb-6">Click "GO LIVE" to start your auction stream</p>
              ...
              {publishing && (
                <div className="mt-4 p-4 bg-green-900/30 border border-green-700 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-green-300 font-semibold">Stream Active</p>
                      <p className="text-green-200 text-sm">Your auction stream is live and viewers can join!</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="lg:col-span-1 space-y-4">
            {/* Auction Panel */}
            <AuctionPanel roomId={channel} isHost={isHost} className="h-[450px]" />
        ...
        {showSetup && !publishing && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800 rounded-lg p-6 w-full max-w-md">
              <h3 className="text-xl font-bold text-white mb-4">Set Up Your Stream</h3>
        ...
        {!publishing && !showSetup && (
          <div className="mt-8 bg-slate-800 rounded-lg p-6">
            <h3 className="text-xl font-bold text-white mb-4">How to Start Your Auction Stream</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">Click the "GO LIVE" button to start your video stream</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl">2️⃣</span>
                </div>
                <h4 className="text-white font-semibold mb-2">Create Auctions</h4>
                <p className="text-slate-300 text-sm">Use the auction panel to create and manage live auctions</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl">3️⃣</span>
                </div>
                <h4 className="text-white font-semibold mb-2">Engage Viewers</h4>
                <p className="text-slate-300 text-sm">Chat with viewers and manage bids in real-time</p>
              </div>
            </div>
          </div>
        )}
