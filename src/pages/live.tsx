      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="bg-slate-800 rounded-lg p-6">
              ...
              <div className="relative">
                <div ref={videoRef} className="w-full h-[480px] bg-black rounded-lg overflow-hidden" />
                ...
                {!isConnecting && !videoReady && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-slate-300 text-sm mt-2">The streamer hasn't gone live yet</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="lg:col-span-1 space-y-4">
            {/* Auction Panel */}
            <AuctionPanel roomId={channel} isHost={false} className="h-[400px]" />
