...
export default function LiveViewer() {
  ...
  const [streamInfo, setStreamInfo] = useState<{hostName?: string, isLive: boolean}>({isLive: false});
    ...
    return (
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-slate-300 mb-6'>Please sign in to watch the livestream</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-white mb-2">Live Auction Stream</h1>
          <p className="text-slate-300">Welcome, {userProfile?.username || currentUser.email}!</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="bg-slate-800 rounded-lg p-6">
                ...
                <div>
                  ...
                  {streamInfo.hostName && (
                    <p className="text-slate-400 text-sm mt-1">
                      Hosted by: <span className="text-cyan-400">{streamInfo.hostName}</span>
                    </p>
                  )}
                </div>
              ...
              <div className="relative">
                <div ref={videoRef} className="w-full h-[500px] bg-black rounded-lg overflow-hidden shadow-2xl" />
                ...
                {!isConnecting && !videoReady && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/70 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-slate-300 text-lg mb-6">The auction stream hasn't started yet</p>
                      <div className="space-y-2 text-slate-400">
                        <p className="text-sm">• Make sure you're in the correct room</p>
                        <p className="text-sm">• The streamer needs to click "Go Live"</p>
                        <p className="text-sm">• Try refreshing the page if the stream doesn't appear</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="mt-4 p-4 bg-green-900/30 border border-green-700 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-green-200 text-sm">Enjoy the live auction!</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="lg:col-span-1 space-y-4">
            {/* Auction Panel */}
            <AuctionPanel roomId={channel} isHost={false} className="h-[450px]" />
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={streamInfo.isLive ? "text-green-400" : "text-yellow-400"}>
        ...
        <div className="mt-8 bg-slate-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">Join the conversation with other viewers</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">Place bids on live auction items</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">Won items go to your cart automatically</p>
            </div>
          </div>
        </div>
      </div>
