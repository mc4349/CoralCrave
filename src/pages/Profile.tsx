...
export default function Profile() {
  ...
  const checkFollowStatus = async () => {
    ...
    try {
      const currentUserProfile = await userService.getUserProfile(
        currentUser.uid
      )
  ...
  const loadFollowingList = async () => {
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        const followingPromises = followingIds.map(
        ...
        const following = (await Promise.all(followingPromises)).filter(
          Boolean
        ) as UserListItem[]
  ...
  const loadPastStreams = async () => {
    try {
      ...
      // Stub implementation - no livestream functionality in minimal tester
      setPastStreams([])
    } catch (err) {
      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          <div className='text-center'>
            <h1 className='text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4'>
              Profile Not Found
            </h1>
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden'>
      ...
      <div className='relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='card p-6'>
          <h2 className='text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-6'>
            Recent Streams
          </h2>
