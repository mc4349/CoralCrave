...
const Activity = () => {
  ...
  const [activeTab, setActiveTab] = useState<'purchases' | 'messages'>(
    'purchases'
  )
      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-slate-400 mb-6'>
            You need to be signed in to view your activity.
          </p>
  ...
  const handlePurchaseClick = (purchaseId: number) => {
    ...
    setSelectedPurchase(
      selectedPurchase === purchaseIdStr ? null : purchaseIdStr
    )
  }
          ...
          <div className='space-y-4'>
            {loading ? (
              ...
              orders.map(order => (
                <div key={order.id}>
                  <div
                    ...
                    onClick={() =>
                      handlePurchaseClick(parseInt(order.id || '0'))
                    }
                  >
                    <div className='flex items-center space-x-4'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-slate-300 text-sm'>
                          Won for ${order.amount.toFixed(2)} from{' '}
                          {order.sellerId}
                        </p>
              ...
              <div className='text-center py-12'>
                ...
                <p className='text-slate-400 mb-6'>
                  You haven't won any auctions yet. Start bidding on live
                  streams to see your purchases here.
                </p>
        ...
        {activeTab === 'messages' && (
          <div className='space-y-4'>
            <div className='text-center py-12'>
              ...
              <p className='text-slate-400 mb-6'>
                Your conversations with sellers will appear here. Start bidding
                on auctions to connect with sellers.
              </p>
              <Link to='/explore' className='btn-primary'>
                Explore Live Auctions
              </Link>
