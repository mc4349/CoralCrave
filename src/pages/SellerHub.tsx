      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20'>
        <div className='text-center mb-16'>
          ...
          <p className='text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed'>
            Track your performance, analyze your sales, and grow your marine
            business with detailed insights.
          </p>
        </div>
        ...
        <div className='flex flex-wrap gap-4 mb-12 justify-center'>
          {['Hourly', 'Daily', 'Weekly', 'Monthly', 'YTD', 'Custom'].map(
            filter => (
              <button
                key={filter}
        ...
        <div className='bg-slate-700/50 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20 hover:border-cyan-400/40 transition-all duration-300'>
          ...
          <div className='space-y-4'>
            {[1, 2, 3].map(i => (
              <div
                key={i}
                className='flex items-center space-x-4 p-4 bg-slate-800/30 backdrop-blur-sm rounded-lg border border-slate-600/50 hover:border-cyan-400/30 transition-all duration-300'
              >
