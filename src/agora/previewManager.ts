...
export class PreviewManager {
  ...
  async startPreview(channelName: string, container: HTMLElement): Promise<void> {
    ...
    try {
      ...
      console.log(`PreviewManager: Starting preview for channel: ${channelName}`);
      ...
      console.log(`PreviewManager: Preview started successfully for ${channelName}`);
  ...
  async stopCurrentPreview(): Promise<void> {
    ...
    console.log(`PreviewManager: Stopping preview for channel: ${this.currentPreview.channelName}`);
